<?php
  ...
  $title="customer Details";$active_menu="customer_list";
...

  {
    ...
    $sel_customer_details=mysqli_query($conn,"SELECT * from vsz_customer WHERE id='".$_REQUEST['id']."' ");

    $fetch=mysqli_fetch_assoc($sel_customer_details);

  }else

  {

    ?><script> window.location.href='manage-customer.php';</script><?php
  ...
  <div class="row mb-2">
    ...
    <div class="col-sm-6">
      ...
      <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item"><a href="manage-customer.php">Customers</a></li>

        <li class="breadcrumb-item active">View All Customer</li>
